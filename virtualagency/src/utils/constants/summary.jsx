...
export const getEnquiryDetails = (formData = {}, dynamicData = {}, formDataList = {}, getLabel, getOptionLabel, response = null, isTrue = false) => {
  return [
    ...
    (isTrue && { label: getLabel("lbl49"), value: `${response?.slaTemplatename || getOptionLabel(formDataList.slaTemplate, formData.slaTemplate) || "-"}` },
